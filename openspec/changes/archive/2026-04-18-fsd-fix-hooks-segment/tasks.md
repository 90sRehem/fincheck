...
- [x] 1.1 Move `use-update-transactions.ts` to model with singular name (`apps/web/src/pages/home/api/use-update-transactions.ts` -> `apps/web/src/pages/home/model/use-update-transaction.ts`)
...
- [x] 1.2 Move `use-transaction.ts` to model (`apps/web/src/pages/home/api/use-transaction.ts` -> `apps/web/src/pages/home/model/use-transaction.ts`)
...
- [x] 1.3 Move `use-remove-transaction.ts` to model (`apps/web/src/pages/home/api/use-remove-transaction.ts` -> `apps/web/src/pages/home/model/use-remove-transaction.ts`)
...
- [x] 2.1 Update imports in `update-transaction.tsx` (`apps/web/src/pages/home/ui/update-transaction.tsx`)
...
- [x] 2.2 Update imports in `remove-transaction.tsx` (`apps/web/src/pages/home/ui/remove-transaction.tsx`)
